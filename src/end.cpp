...
End::End(float x, float y, float speed, color_t color) {
   ...
   // this->rotation = 0;
    ...
    static const GLfloat vertex_buffer_data[] = {
        ...
        -0.30f,-3.0f,0.0f, // triangle 1 : begin
        -0.30f,2.0f, 0.0f,
        0.30f, 2.0f, 0.0f,
        -0.30f,-3.0f,0.0f, // triangle 1 : begin
        0.30f,-3.0f, 0.0f,
        0.30f, 2.0f, 0.0f,
        -0.30f,2.0f,0.0f, // triangle 1 : begin
        -0.30f,0.0f, 0.0f,
        -1.50f, 1.0f, 0.0f // triangle 1 : end
...
void End::set_position(float x, float y) {
    this->position = glm::vec3(x, y, 0);
}
