...
Circl::Circl(float x, float y, float r,float speed,color_t color) {
...
void Circl::set_position(float x, float y) {
    this->position = glm::vec3(x, y, 0);
}
...
bounding_box_t Circl::getstruct(){
    bounding_box_t t1;
