...
Man::Man(float x, float y, float speed, int state, color_t color) {
   ...
   // this->rotation = 0;
    ...
    static const GLfloat vertex_buffer_data[] = {
        ...
        -0.20f,0.50f,0.0f, // triangle 1 : begin
        -0.20f,-0.50f, 0.0f,
        0.20f, 0.50f, 0.0f, // triangle 1 : end
        -0.20f, -0.50f,0.0f, // triangle 2 : begin
        0.20f,0.50f,0.0f,
        0.20f, -0.50f,0.0f
